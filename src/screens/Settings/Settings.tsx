  ...
  return (
      <div className="w-full px-4 py-6">
          ...
          <div className="divide-y divide-gray-100">
            ...
            <SettingsItem icon="🏅" label="実績確認" to="#" />
            <SettingsItem icon="🎨" label="テーマ設定" to="/settings/theme" />
            <SettingsItem icon="🔔" label="通知設定" to="/settings/notifications" />
            <SettingsItem icon="📄" label="利用規約" to="#" />
            <SettingsItem icon="🔐" label="プライバシーポリシー" to="#" />
            <SettingsItem icon="💬" label="ヘルプとフィードバック" to="#" />
            <SettingsItem icon="ℹ️" label="このアプリについて" to="#" />
          </div>
